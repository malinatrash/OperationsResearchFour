...
def doLinearProgNull():
    ...
    model0 += 1 * x01 + 1 * x02 + 1 * x03 + 1 * x04 + 1 * x05  # Целевая функция
...
def doLinearProgOne():
    ...
    model1 += 1 * x11 + 1 * x12 + 1 * x13 + 1 * x14 + 1 * x15  # Целевая функция
...
def doLinearProgTwo():
    ...
    model2 += 1 * x21 + 1 * x22 + 1 * x23 + 1 * x24 + 1 * x25  # Целевая функция
